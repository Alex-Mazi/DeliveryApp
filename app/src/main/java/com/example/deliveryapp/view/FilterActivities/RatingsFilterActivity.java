...
public class RatingsFilterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler(Looper.getMainLooper(), message -> {
            if (message.what == 1){
                Toast.makeText(RatingsFilterActivity.this, "Connection OK! "+items.size(), Toast.LENGTH_SHORT).show();
        ...
        submitButton.setOnClickListener(v -> {
            ...
            if (longitude.isEmpty() && latitude.isEmpty()) {
                ...
                Thread clientThread = new Thread(new ClientThread(handler,"192.168.1.84", 5000, longitude,latitude,selectedCategory,"search_ratings"));
                clientThread.start();
            }
